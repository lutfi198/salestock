 ...
 */
require(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojmodule', 'ojs/ojknockout'], // add additional JET component modules as needed
        function (oj, ko, $) // this callback gets executed when all required modules are loaded
        {
          function SwapiViewModel() {
          }
          $(document).ready(
                  function ()
                  {
                    ko.applyBindings(new SwapiViewModel());
                  }
          );
        }
);
